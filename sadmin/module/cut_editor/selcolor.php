...
function initiate() {
	if (obj.color_swatches == '') {
		...
		colorTable += '<tr><td height="14" class="colorCell" bgcolor="" colspan="19" align="center">По умолчанию</td></tr></table>';
...
function end() {
	parentWindow.wp_docolor(obj,action,document.getElementById('selcolor').value)
	window.close();
	return false;
}
	...
	<div id="tab_container"> 
		...
		<div id="web_color_container" style="display:none"> 
			<table id="web_colortable" width="100%" border="0" cellspacing="0" cellpadding="0" class="colortable">
				...
				<tr> 
					<td class="colorCell" bgcolor="" colspan="19" align="center"><?=$dl[25];?></td>
				</tr>
			</table>
		</div>
	</div>
