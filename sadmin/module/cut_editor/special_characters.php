...
<div align="center" id="dialogLoadMessage" style="display:block;">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="4">
		<tr> 
			<td align="center" width="100%"><fieldset>
				<legend><?=$dl[131];?>:</legend>
				<?=$dl[132];?>: 
				<input id="insert" name="insert" type="text" size="10" onChange="man_character()">
				&nbsp; <span id="characterspan"></span> &nbsp;&nbsp;&nbsp;&nbsp; 
				<br>
				<br>
				<table id="CharacterTable" border="1" cellspacing="0"  cellpadding="3" bgcolor="#FFFFFF" width="461" bordercolor="#000000">
					<tr> 
	...
	<!--//
		if (!parentWindow.wp_is_ie50) {
			document.getElementById('CharacterTable').style.borderCollapse = 'collapse';
		}
	//-->
	</script>
</div></form>
