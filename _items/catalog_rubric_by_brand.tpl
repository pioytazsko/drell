...
<div style="display:block;float:left;padding-right:20px;padding-bottom:25px; height:170px">
	...
	<tr height="75px">
	<td align="left" width="175px" style="padding-left:30px;padding-bottom:15px;"><a href="<? echo "catalog.php?id=".[id]."&brand=".$_GET['id'];?>"><img src="<? echo $image;?>" border="0"></a></td>
	</tr>
	<tr height="">
	<td align="left" width="175px"><a href="<? echo get_link('[id]', 'brand='.$_GET['id']);?>" style="text-decoration:none;"><h1>[name]</h1></a></td>
	</tr>
	</table>
</div>
</div>